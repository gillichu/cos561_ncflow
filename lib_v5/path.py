...
if __name__ == '__main__':
    ...
    G_agg, agg_edge_dict, agg_to_orig_nodes, orig_to_agg_node, G_clusters_dict, agg_commodities_dict, clusters_commodities_dict, meta_to_virt_dict, virt_to_meta_dict = construct_subproblems(G, tm, num_clusters=num_clusters)
